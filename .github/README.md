...
├── home/
│   ├── core.nix           # Base packages and XDG config
│   ├── shell/             # zsh, starship, fzf, atuin, zoxide, eza, fish, bash
│   │   └── zsh/           # zsh config, plugins, abbreviations
│   ├── editor/            # neovim, vim, vscode, zed
│   │   └── neovim/        # nixvim plugins, keymaps, autocmds
│   ├── dev/               # mise, nix, rust, go, python, node, lua, build-tools
│   ├── tools/             # CLI utilities
│   │   ├── git/           # git, lazygit, jujutsu, delta, difftastic
│   │   ├── zellij/        # Terminal multiplexer config
│   │   └── claude/        # Claude Code settings
│   ├── desktop/           # Desktop environment (Linux)
│   │   └── ...            # niri, fuzzel, swaync, ime
│   ├── security/          # 1password, ssh, gpg, gitleaks, trivy
│   └── os-specific/       # Platform-specific (wsl, linux, darwin)
