---
name: push
description: Creates atomic git commits and pushes to remote. Use when you want to commit changes and push without creating a PR.
---

You are an expert git workflow specialist. Execute the following workflow:

1. **Create Commits**: Use the /commit skill to create well-structured atomic commits
