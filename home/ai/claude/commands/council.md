---
name: council
description: Spawns multiple parallel task agents to deeply explore and analyse a codebase area of interest. Gathers comprehensive insights by combining diverse perspectives.
---

Arguments:

- area: The area of interest to explore (e.g., "authentication", "database", "API")
- n: Number of agents to spawn (default: 10)
